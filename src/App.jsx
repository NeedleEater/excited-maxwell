            ...
            <section className="profile-section animate-on-scroll">
              <div className="profile-split-grid">
                ...
                <div className="profile-info-col">
                  ...
                  {/* Social & Contact Compact Trigger / Chip Bar */}
                  <div className="social-chip-group">
                    <span className="social-chip-label">Connect:</span>
                    <span 
                      className="social-chip-item disabled-link"
                    ...
                    <span className="social-chip-dot">•</span>
                    <a 
        ...
        <div className="container">
          <div className="footer-contact animate-on-scroll">
            ...
            <div className="footer-social-links">
              <span 
                className="footer-social-btn disabled-link"
                aria-label="GitHub Profile"
              >
                GitHub
              </span>
